...
// Definindo uma constante para o número de territórios
#define NUM_TERRITORIOS 5

// -----------------------------
// Estrutura: Territorio
// -----------------------------
// Armazena os dados de um território: nome, cor do exército e tropas.
typedef struct {
    char nome[30];
    char cor[10];
    int tropas;
...
// -----------------------------
int main() {
    // Vetor de estruturas para armazenar os 5 territórios
    ...
    for (int i = 0; i < NUM_TERRITORIOS; i++) {
        ...
        printf("\n"); // Quebra de linha entre os cadastros
    }
